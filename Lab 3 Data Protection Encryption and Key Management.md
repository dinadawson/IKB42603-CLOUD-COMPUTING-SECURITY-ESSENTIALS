...
`[SCREENSHOT: Task 1 — encrypt, gibberish output, decrypt, MATCH]`
...
`[SCREENSHOT: Task 4 — create-key output with KeyId + encrypt output]`
...
`[SCREENSHOT: Task 5 — generate-data-key output + final file listing showing only datakey.enc and record.env.enc remain]`
